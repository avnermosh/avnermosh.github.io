...
THREE.EditOverlayRect_Scene3D_TrackballControls = function ( pivotGroup,
                                                       structureMeshGroup,
                                                       overlayMeshGroup,
...
//         console.log('BEG onDocumentMouseDown');
        ...
        let intersectedStructureInfo = MLJ.core.Scene3D.getIntersectionStructureInfo();
        let intersectedOverlayRectInfo = MLJ.core.Scene3D.getIntersectionOverlayRectInfo();
        let intersectedOverlayVertexInfo = MLJ.core.Scene3D.getIntersectionOverlayVertexInfo();
        ...
        switch ( event.button ) {
            ...
            case STATE.EDIT_OVERLAY_RECT:
                ...
                _selectedOverlayVertexObj = MLJ.util.getNestedObject(intersectedOverlayVertexInfo, ['currentIntersection', 'object']);
                ...
                {
                    let intersectedOverlayRectObjectId = MLJ.util.getNestedObject(intersectedOverlayRectInfo, ['currentIntersection', 'object', 'id']);
                    if( intersectedOverlayRectObjectId)
                    {
                        ...
                        selectedLayer.deleteImageFromOverlayRect(intersectedOverlayRectObject);
                    }
                }
                else if(editMode == 'UpdateRect')
                {
                    ...
                    if(_selectedOverlayRectObj || _selectedOverlayVertexObj)
                    {
                        ...
                        {
                            /////////////////////////////////////////////////////////
                            // An overlayRect or a vertice is selected
                        ...
                        // set the mouse icon shape to a "hand folded" to indicate that
    ...
    function onDocumentMouseMove( event ) {
        ...
        if ( _selectedOverlayRectObj || _selectedOverlayVertexObj ) {
            ...
            // and use the new intersection point for either translation
            // or scaling of the overlayRect
            /////////////////////////////////////////////////////////
        ...
        /////////////////////////////////////////////////////////
        // If hovering over overlayRect or one of its vertices
        // set the mouse icon shape to a "hand with finger" to indicate that
        // the object can be updated or deleted
        /////////////////////////////////////////////////////////
        
        _raycaster.setFromCamera( _mouse, _camera );

        var overlayRectsAndVertices = overlayMeshGroup.children.concat(selectedOverlayVertexHelperGroup.children);
        var intersects = _raycaster.intersectObjects( overlayRectsAndVertices, true );
...
THREE.EditOverlayRect_Scene3D_TrackballControls.prototype = Object.create( THREE.EventDispatcher.prototype );
THREE.EditOverlayRect_Scene3D_TrackballControls.prototype.constructor = THREE.EditOverlayRect_Scene3D_TrackballControls;
