...
THREE.CSS2DRenderer = function () {
    ...
    this.calcPositionFromTranslateAttribute = function ( object, transX, transY )
    {
        if ( object instanceof THREE.CSS2DObject ) {
            ...
            var positionVec = new THREE.Vector3();
            positionVec.setFromMatrixPosition( object.matrixWorld );
            positionVec.applyMatrix4( viewProjectionMatrix );

            // let viewProjectionMatrixInv = new THREE.Matrix4().getInverse( viewProjectionMatrix );
            // positionVec.applyMatrix4( viewProjectionMatrixInv );

            let viewProjectionMatrixInv = new THREE.Matrix4().getInverse( viewProjectionMatrix );
	    var positionVec2 = new THREE.Vector3(x1, y1, vector.z);
	...
	if ( object instanceof THREE.CSS2DObject ) {
	    ...
	    var positionVec = new THREE.Vector3(x1, y1, vector.z);
	    ...
	    var element = object.element;
            ...
            // add scale - based on https://github.com/mrdoob/three.js/issues/9246
