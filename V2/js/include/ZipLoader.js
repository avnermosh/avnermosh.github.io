         ...
         function ()
         {
             ...
             */
             ...
             var parseZip = function parseZip(buffer, doSkipJpg, offsetInReader)
             {
                 ...
                 // console.log('typeof offsetInReader', typeof offsetInReader);
                 
                 var reader = new _class(buffer);
                 var files = {};

                 if (typeof offsetInReader === 'undefined')
                 {
                     // Parse multiple files in the zip file
                 ...
                 {
                     // Parse single file in the zip file
             ...
             var parseLocalFileHeader = function parseLocalFileHeader(reader) {
                 ...
                 var i = 0;
                 var offsetInReader = reader.position;
             ...
             var parseLocalFileDataBuffer = function parseLocalFileDataBuffer(reader, offsetInReader, compressedSize, compression, filename) {
                 var data = void 0;
                 var i = 0;
                 var compressedData = new Uint8Array(compressedSize);
             ...
             var parseLocalFile = function parseLocalFile(reader, doSkipJpg) {
                 ...
                 if (typeof doSkipJpg === 'undefined') {
                     ...
                     doSkipJpg = false;
                     console.log('doSkipJpg is undefined. Set it to default of false');
                 }
                 ...
                 if(doSkipJpg)
                 {
                     ...
                     if(regex1_matched)
                     {
                         // console.log('regex1_matched. Skip file');

                         reader.skip(fileHeaderAttributes.compressedSize);

                         return {
                             name: filename,
                             offset: fileHeaderAttributes.offsetInReader,
                             buffer: ""
                         };
                     }
                 }

                 var file2 = parseLocalFileDataBuffer(reader,
                                                      fileHeaderAttributes.offsetInReader,
                                                      fileHeaderAttributes.compressedSize,
                                                      fileHeaderAttributes.compression,
                                                      fileHeaderAttributes.filename);
                 return file2;
             ...
             var ZipLoader = function () {
                 ...
                 ZipLoader.prototype.getImageTags = function getImageTags(filename, blob) {
                     ...
                     return new Promise(function(resolve, reject){
                         ...
                         reader.onloadend = function(e) {
                             ...
                             let doEnableExifTags = true;
                             doEnableExifTags = false;
                             if(doEnableExifTags)
                             {
                                 ...
                                 let val1 = view.getUint16(0, false);
                                 if (val1 != 0xFFD8)
                                 {
                                     ...
                                     console.error('Error. mandatory jpeg flag 0xFFD8 is missing');
                                     return reject(false);
                                 }
                                 ...
                                 while (offset < length) 
                                 {
                                     ...
                                     if (marker == 0xFFE1) 
                                     {
                                         ...
                                         {
                                             // 0x45786966 - ascii hex values of the string 'Exif'                                         
                                             console.error('could not find Exif header'); 
                                             return resolve(result2);
                                             // return reject(false);
                                         }
			     ...
			     // console.log('END reader.onload');
                         ...
                         // console.log('after readAsArrayBuffer');
                 ...
                 ZipLoader.prototype.extractImageAsBlobUrl = function extractImageAsBlobUrl(filename, type) {
                     ...
                     return new Promise(function(resolve, reject){
                         ...
                         // TBD getImageTags is used also from outside ZipLoader. The function could be generalized out of ZipLoader into
                         // a new js file e.g. imageUtils.js
                         let promise_getImageTags = this3.getImageTags(filename, blob);

                         promise_getImageTags.then(function(result2) {
                             ...
                             let results_imageTags = {};
                             results_imageTags.filename = filename;
                             results_imageTags.imageOrientation = result2.imageOrientation;
                             // results_imageTags.imageWidth = result2.imageWidth;
                             // results_imageTags.imageHeight = result2.imageHeight;
                             results_imageTags.url = instance.files[filename].url;
                             resolve(results_imageTags);
                             
                         }).catch(function(err) {

                             console.error('error from promise_getImageTags: ', err);
                             reject(false);
                         });                         
                     });
