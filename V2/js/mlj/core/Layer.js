...
MLJ.core.Layer = function (id, name)
{
    ...
    this._selectedImageFilenamePrev;
    ...
    this.getSelectedImageFilenamePrev = function () {
        return this._selectedImageFilenamePrev;
    };

    this.setSelectedImageFilenamePrev = function (selectedImageFilenamePrev) {
        this._selectedImageFilenamePrev = selectedImageFilenamePrev;
    };
...
//         console.log('this._selectedFloorInfo', this._selectedFloorInfo);
    ...
    this.loadNextImage = function () {
        if(this._selectedOverlayRectObj && this._selectedImageFilenames.length > 0)
        {
            ...
            this._selectedImageFilename = this._selectedImageFilenames[this._selectedImageFilenameIndex];
            
            if(this._blobs.getByKey(this._selectedImageFilename))
            {
                let imageInfo = this._imageInfoVec.getByKey(this._selectedImageFilename);
                MLJ.core.ImageFile.updateMaterial(this._selectedOverlayRectObj,
                                                  this._blobs.getByKey(this._selectedImageFilename),
                                                  this._selectedImageFilename,
...
//         console.log('BEG loadTheSelectedImageAndRender'); 
        ...
        if(!this._selectedImageFilename)
        {
            // sanity check. Shouldn't reach here
            throw 'this._selectedImageFilename is undefined"';
        }
        ...
        // sanity check
        if( this._selectedImageFilename !== imageInfo.filename)
        {
            console.error('this._selectedImageFilename', this._selectedImageFilename); 
            console.error('imageInfo.filename', imageInfo.filename);
            throw 'Reached failure condition: "this._selectedImageFilename !== imageInfo.filename"';
        }
        ...
        if(blobs.getByKey(this._selectedImageFilename))
        {
            ...
            this._selectedImageFilenamePrev = this._selectedImageFilename;
...
//             console.log('this._selectedImageFilename', this._selectedImageFilename);
    ...
    this.clearSelectedImageInfo = function () {
        ...
        // There is no overlayRect intersection. Setting the _selectedImageFilename to be noSelectedImage.
        // causes the previous "real" _selectedImageFilename if any, to be removed
        this._selectedImageFilename = "noSelectedImage.jpg";
    ...
    this.setSelectedImageInfo = function (intersectedOverlayRectInfo) {
        ...
        if(intersectedOverlayRectObject)
        {
            ...
            if ( !intersectedOverlayRectObjectPrev || (intersectedOverlayRectObjectPrev != intersectedOverlayRectObject) )
            {
                ...
                // this._selectedImageFilenameIndex, _selectedImageFilename
    ...
    this.createRectangleMesh = function (structureRectangleVertices) {
        ...
        // TBD - sanity check - check that default_image.jpg is in the zip file
        // Not done yet...
        ...
        this._imageInfoVec.set(imageFilename, imageInfo);
    ...
    this.deleteImageFromOverlayRect = function (intersectedOverlayRectObject) {
        ...
        if(intersectedOverlayRectObject)
        {
            ...
            else
            {
                ...
                let imageFilenameToRemove = this._selectedImageFilename;
